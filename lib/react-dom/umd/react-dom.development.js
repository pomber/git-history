...
function sanitizeURL(url) {
  if (disableJavaScriptURLs) {
    !!isJavaScriptProtocol.test(url) ? invariant(false, 'React has blocked a javascript: URL as a security precaution.%s', ReactDebugCurrentFrame$1.getStackAddendum()) : void 0;
...
var shouldYield$1 = unstable_shouldYield;
...
function scheduleCallbackWithExpirationTime(root, expirationTime) {
  ...
  callbackID = scheduleCallback(performAsyncWork, { timeout: timeout });
}
